    ...
    useEffect(() => {
        ...
        <div className="valign-wrapper">
            <div className="col s1 valign-wrapper">
                <i className="tooltipped material-icons teal-text text-lighten-4" data-position="bottom" data-tooltip={options.html} >info</i>
            </div>
            <div className=" file-field input-field col s11 valign-wrapper">
                ...
                <div className="file-path-wrapper">
                    <input className="file-path validate" placeholder={names[props.type][1]} type="text" onChange = {props.uploadFile} />
                </div>
