                    ...
                    try {
                        if (firstAzymuth) {
                            this.state.vectors.map((el) => {
                                ...
                                if(!dist) {throw new Error('Błąd na punkcie ' + el.number);}
                                ...
                                if (crossSection[0]) {
                                    intersectBox.push(Object.assign({
                                        number: nr,
                                        z: height_XZ
                                    }, {
                                        ...crossSection[0]
    ...
    return (
        <div>
            ...
            <div className="fixed-action-btn">
                <button className="btn-floating btn-large waves-effect red" onClick= {()=>{this.handleCalculateIntersection(this.state)}}>
                    Oblicz
                </button>
            </div>
                ...
                <div>
                    <div className="selectGraphType row">
                        ...
                        <div className="col s4 offset-s4 center-align">
                            ...
                            <select className="browser-default" onChange={(e) => this.setState({ graphType: e.target.value })}>
                    ...
                    <div className="row graphBox"></div>
                </div>
        </div>
    );
